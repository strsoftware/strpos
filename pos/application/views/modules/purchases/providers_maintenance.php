  <div id="content">
    <div id="content-header">
      ...
      <a href="<?php echo base_url('purchases/providers')?>" class="current">Mantenimiento de Proveedores</a> </div>
                  ...
                  <tr class="gradeA">
                    ...
                    <td>
                      <div class="str-pagination">
                        <ul>
                          <li><a href="<?php echo base_url('purchases/providers/editar/'.$row->pos_provider_id)?>" title="Editar"><i class="icon-edit"></i></a></li>
